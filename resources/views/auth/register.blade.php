...
@section('content')
    <div class="hero-wrap js-fullheight ftco-section ftco-book ftco-no-pt ftco-no-pb"
        style="background-image: url('{{ asset('assets/images/image_2.jpg') }}');" data-stellar-background-ratio="0.5">
